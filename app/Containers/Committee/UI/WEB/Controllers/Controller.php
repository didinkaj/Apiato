...
class Controller extends WebController
{
    ...
    public function index(GetAllCommitteesRequest $request)
    {
        ...
        return view('committee::get-all-committee',['committees'=>$committees]);
    ...
    public function show(FindCommitteeByIdRequest $request)
    {
        ...
        return view('committee::show-committee',['committee'=>$committee]);
    ...
    {
        $committee = Apiato::call('Committee@FindCommitteeByIdAction', [$request]);
        return view('committee::edit-committee',['committee'=>$committee]);
