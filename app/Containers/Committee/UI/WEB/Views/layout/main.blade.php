...
<div id="app" class="page">
    <!--top bar nar-->
@include('committee::layout.includes.header')
    ...
    <div class="grid-container mainsection">
        <div class="grid-x content-area">
            ...
            <div class="cell medium-3">
                @section('sidebar')
                    @include('committee::layout.includes.sidebar')
                @show
            </div>
            <!-- content -->
            <div class="cell medium-7 medium-offset-1">
                <ul class="breadcrumbs">
                    <li><a href="{{route('web_committee_index')}}">Committees</a></li>
                    <li>
                        <span class="show-for-sr">Current: </span> @yield('title')
                    </li>
                </ul>
                @include('committee::slots.error')
...
<footer class="grid-container  fluid grid-margin-x footer-section">
    <div class="grid-x">
        <div class="cell text-center">
            @include('committee::layout.includes.footer')
        </div>
    </div>
</footer>
</div>
